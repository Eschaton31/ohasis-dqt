...
# Created by Gab Saplagio and Ruela Haynes
# Importing Code for Marikina SHC Treatment

mrs <- read_sheet("13drdF5mWvAPJPgb-BUinH-tg8kGUbp56GjSsY4_CSGU", "nov_visits", col_types = "c")
...
form_art_bc <- QB$new(conn)$
   ...
   whereBetween("art.VISIT_DATE", c("2024-11-01", "2024-11-30"))$
   whereNotNull("MEDICINE_SUMMARY")$
   where("FACI_ID", "130005")$
   select("VISIT_DATE")$
