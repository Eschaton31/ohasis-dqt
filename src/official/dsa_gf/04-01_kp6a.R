...
gf$linelist$kp6a <- gf$harp$prep$new_reg %>%
      ...
      y  = bind_rows(
         ...
         mutate(
            ...
            SEX_ANAL_RECEIVE = case_when(
               ...
               RECORD_P12M <= EXPOSE_SEX_M_AV_DATE & EXPOSE_SEX_M_AV_DATE < EXPOSE_SEX_M_AV_NOCONDOM_DATE ~ "Y",
               str_left(RISK_M_SEX_ORAL_ANAL, 1) == "1" ~ "Y",
               str_left(RISK_M_SEX_ORAL_ANAL, 1) == "2" ~ "Y",
               str_left(RISK_CONDOMLESS_ANAL, 1) == "1" ~ "Y",
               str_left(RISK_CONDOMLESS_ANAL, 1) == "2" ~ "Y",
            ...
            analp12m         = case_when(
               ...
               RECORD_P12M > EXPOSE_SEX_M_AV_DATE & EXPOSE_SEX_M_AV_DATE < EXPOSE_SEX_M_AV_NOCONDOM_DATE ~ ">p12m",
               str_left(RISK_M_SEX_ORAL_ANAL, 1) == "1" ~ "w/in 12m",
               str_left(RISK_M_SEX_ORAL_ANAL, 1) == "2" ~ ">p12m",
               str_left(EXPOSE_SEX_M_NOCONDOM, 1) == "2" ~ ">p12m",
               str_left(RISK_CONDOMLESS_ANAL, 1) == "1" ~ "w/in 12m",
               str_left(RISK_CONDOMLESS_ANAL, 1) == "2" ~ ">p12m",
   ...
   mutate(
      ...
      `DISAG 3`        = case_when(
         # str_left(RISK_CONDOMLESS_ANAL, 1) %in% c("0", "2") & analp12m == "w/in 6m" ~ "1) Sexual Risk (anal sex) past 6 months",
         # str_left(RISK_CONDOMLESS_ANAL, 1) %in% c("0", "2") & analp12m == "w/in 12m" ~ "2) Sexual Risk (anal sex) past 12 months",
         # str_left(RISK_CONDOMLESS_ANAL, 1) %in% c("0", "2") & analp12m == ">p12m" ~ "3) Sexual Risk (anal sex) >12 months",
         # str_left(RISK_CONDOMLESS_ANAL, 1) == "4" ~ "0) Sexual Risk (anal sex) past 30 days",
         # str_left(RISK_CONDOMLESS_ANAL, 1) == "3" ~ "1) Sexual Risk (anal sex) past 6 months",
         # str_left(RISK_CONDOMLESS_ANAL, 1) == "1" ~ "2) Sexual Risk (anal sex) past 12 months",
         # str_left(RISK_CONDOMLESS_ANAL, 1) == "2" ~ "3) Sexual Risk (anal sex) >12 months",
