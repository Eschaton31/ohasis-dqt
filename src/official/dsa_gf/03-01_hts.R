...
gf$linelist$hts <- gf$logsheet$combined %>%
   ...
   mutate(
      ...
      `DISAG 1`        = case_when(
         ...
         risk_sexwithm == "yes-p01m" ~ "1) Sexual Risk (anal sex) past 6 months",
         risk_sexwithm == "yes-p03m" ~ "1) Sexual Risk (anal sex) past 6 months",
         risk_sexwithm == "yes-p06m" ~ "1) Sexual Risk (anal sex) past 6 months",
         # analp12m == "w/in 12m" ~ "2) Sexual Risk (anal sex) past 12 months",
         risk_sexwithm == "yes-p12m" ~ "2) Sexual Risk (anal sex) past 12 months",
         # analp12m == ">p12m" ~ "3) Sexual Risk (anal sex) >12 months",
         risk_sexwithm == "yes-beyond_p12m" ~ "3) Sexual Risk (anal sex) >12 months",
