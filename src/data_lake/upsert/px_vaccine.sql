SELECT rec.REC_ID,
       ...
       MAX(IF(vax.DISEASE_VAX = 'COVID19' AND vax.VAX_NUM = 2, vax.IS_VAX, NULL))                      AS VAX_COVID29_2ND_DONE,
       MAX(IF(vax.DISEASE_VAX = 'COVID19' AND vax.VAX_NUM = 2, vax.VAX_DATE,
              NULL))                                                                                   AS VAX_COVID29_2ND_DATE,
       MAX(IF(vax.DISEASE_VAX = 'COVID19' AND vax.VAX_NUM = 2, vax.VAX_REMARKS,
              NULL))                                                                                   AS VAX_COVID29_2ND_LOCATION,
       ...
       MAX(IF(vax.DISEASE_VAX = 'HEPB' AND vax.VAX_NUM = 2, vax.IS_VAX, NULL))                         AS VAX_COVID29_2ND_DONE,
       MAX(IF(vax.DISEASE_VAX = 'HEPB' AND vax.VAX_NUM = 2, vax.VAX_DATE, NULL))                       AS VAX_COVID29_2ND_DATE,
