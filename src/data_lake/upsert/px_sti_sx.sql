SELECT rec.REC_ID,
       ...
       MAX(IF(sti.STI_SYMPTOM = 10, IS_SYMPTOM, NULL))                                                 AS STI_SX_DISCHARGE_OROPHARYNGEAL,
       MAX(IF(sti.STI_SYMPTOM = 11, IS_SYMPTOM, NULL))                                                 AS STI_SX_BLISTER,
       MAX(IF(sti.STI_SYMPTOM = 12, IS_SYMPTOM, NULL))                                                 AS STI_SX_ULCERS,
       MAX(IF(sti.STI_SYMPTOM = 13, IS_SYMPTOM, NULL))                                                 AS STI_SX_WARTS,
       MAX(IF(sti.STI_SYMPTOM = 14, IS_SYMPTOM, NULL))                                                 AS STI_SX_MASS,
       MAX(IF(sti.STI_SYMPTOM = 16, IS_SYMPTOM, NULL))                                                 AS STI_SX_FOUL_ODOR,
       MAX(IF(sti.STI_SYMPTOM = 17, IS_SYMPTOM, NULL))                                                 AS STI_SX_RASHES,
       MAX(IF(sti.STI_SYMPTOM = 18, IS_SYMPTOM, NULL))                                                 AS STI_SX_REDNESS,
       MAX(IF(sti.STI_SYMPTOM = 19, IS_SYMPTOM, NULL))                                                 AS STI_SX_LICE,
       MAX(IF(sti.STI_SYMPTOM = 20, IS_SYMPTOM, NULL))                                                 AS STI_SX_ABSCESS,
