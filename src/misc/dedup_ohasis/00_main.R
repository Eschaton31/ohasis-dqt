...
check_dupes <- ohasis_dupes(FIRST, UIC, CLIENT_EMAIL)
check_dupes <- ohasis_dupes(FIRST, BIRTHDATE, CLIENT_EMAIL)
check_dupes <- ohasis_dupes(FIRST_NY, UIC, CLIENT_EMAIL)
check_dupes <- ohasis_dupes(FIRST_NY, BIRTHDATE, CLIENT_EMAIL)
check_dupes <- ohasis_dupes(FIRST, UIC, PERM_PROV)
check_dupes <- ohasis_dupes(FIRST, LAST_NY, BIRTHDATE, PERM_MUNC)
check_dupes <- ohasis_dupes(FIRST, UIC, CURR_PROV)
check_dupes <- ohasis_dupes(FIRST, LAST_NY, BIRTHDATE, CURR_MUNC)
check_dupes <- ohasis_dupes(FIRST, BIRTHDATE, PXCODE_SIEVE)
check_dupes <- ohasis_dupes(FIRST, BIRTH_YR, CLIENT_MOBILE)
check_dupes <- ohasis_dupes(FIRST, BIRTH_MO, CLIENT_MOBILE)
check_dupes <- ohasis_dupes(FIRST, BIRTH_DY, CLIENT_MOBILE)
...
check_dupes <- ohasis_dupes(FIRST, BIRTH_YR, CLIENT_EMAIL)
check_dupes <- ohasis_dupes(FIRST, BIRTH_MO, CLIENT_EMAIL)
check_dupes <- ohasis_dupes(FIRST, BIRTH_DY, CLIENT_EMAIL)
